...
public class LoginFeatureSteps {
    ...
    @And("first name  = {string}, second name = {string}, lastname = {string}, Phone={string}, email = {string}, tenUser = {string}, tenPass = {string} for tenant and username is available and used two database queries")
